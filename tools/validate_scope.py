...
from ._support.bench import Validator, validation_session, managed_afg, afg_setup, evidence_metadata
...
def main() -> int:
    ...
    v.report.update(evidence_metadata(args))
    v.save_report()
    ...
    with validation_session(v), WaveRecorder(host=args.host) as rec, managed_afg(rec, v, afg_sources):
        ...
        if not args.no_metadata:
            from ._support.captures import run_metadata_checks
